...
const CONVERT_STABLE_TO_LEVER_LST: [u8; 8] = [70, 153, 236, 141, 152, 102, 238, 157];
const CONVERT_LEVER_TO_STABLE_LST: [u8; 8] = [203, 251, 143, 181, 230, 117, 64, 207];
...
pub fn swap(op: HyloOp, amount_in: u64, account_metas: &[AccountMeta]) -> Result<Vec<Instruction>> {
