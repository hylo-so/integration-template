...
pub enum AmmError {
  ...
  /// The deserialization of the Token state returned something besides
  /// State::Token.
  #[error("ExpectedMint")]
  ExpectedMint,
  /// The deserialization of the Token state returned something besides
  ...
  InvalidTokenLP,
  /// The dest_token_coin provided doesn't match the dest_token_coin in
  /// WithdrawTokenInfo.
  #[error("InvalidDestTokenCoin")]
  InvalidDestTokenCoin,
  /// The dest_token_pc provided doesn't match the dest_token_pc in
  /// WithdrawTokenInfo.
  ...
  #[error("InvalidMarket")]
  InvalidMarket,
  /// The market program provided doesn't match the market program in the
  /// AmmInfo.
  ...
  #[error(
    "Init lp amount is too less(Because 10**lp_decimals amount lp will be \
     locked)"
  )]
  InitLpAmountTooLess,
  /// Unknown Amm Error
